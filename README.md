...
- 00.29 PM, Apr 06, 2026 (**v3.05.5**): **SSJ Developer Mode, Telegram Bridge, Worker Command, and UX improvements** (Appreciate the contribution from [@mxh1999](https://github.com/mxh1999), merged from [PR #19](https://github.com/SafeRL-Lab/clawspring/pull/19))
